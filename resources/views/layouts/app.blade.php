...
<head>
    ...
    <title>{{ config('Ikintu cyambere ni amakuru | IMBERE') }}</title>
    ...
    {{--    @vite('admin/assets/css/soft-ui-dashboard-tailwind.css?v=1.0.5')--}}
    <!-- Scripts -->
...
<aside
    ...
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="{{route('dashboard')}}" target="">
            ...
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand"> IMBERE </span>
        </a>
    </div>
    ...
    <div class="items-center block w-auto max-h-screen  h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            <li class="mt-0.5 w-full">
                <a class="@yield('DASHBOARD_SELECTED') py-2.7  text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                   href="{{route('dashboard')}}">
                    <div
                        class="@yield('DASHBOARD_SELECTED_ICON')  shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            ...
            @if(Auth::user()->role == 'primary_admin')
                <li class="mt-0.5 w-full">
                    <a class="@yield('USER_SELECTED') py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                       href="{{route('admin.users')}}">
                        <div
                            class="@yield('USER_SELECTED_ICON') shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            ...
            <li class="mt-0.5 w-full">
                <a class="@yield('CATEGORY_SELECTED')  py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                   href="{{route('admin.category')}}">
                    <div
                        class="@yield('CATEGORY_SELECTED_ICON') shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
            ...
            <li class="mt-0.5 w-full">
                <a class="@yield('ARTICLE_SELECTED')  py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                   href="{{route('admin.article')}}">
                    <div
                        class="@yield('ARTICLE_SELECTED_ICON') shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
                             xmlns="http://www.w3.org/2000/svg">
                            <title>credit-card</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="mt-0.5 w-full">
                <a class="@yield('ADS_SELECTED')  py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                   href="{{route('admin.ads')}}">
                    <div
                        class="@yield('ADS_SELECTED_ICON') shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
                             xmlns="http://www.w3.org/2000/svg">
                            <title>credit-card</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft"> ADS </span>
                </a>
            </li>
            ...
            <li class="mt-0.5 w-full">
                <a class=" @yield('PROFILE_SELECTED') py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                   href="{{route('profile.edit')}}">
                    <div
                        class="@yield('PROFILE_SELECTED_ICON') shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            ...
            <li class="mt-0.5 w-full">
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                       onclick="event.preventDefault(); this.closest('form').submit();" href="javascript(void)">
                        <div
    ...
    <div fixed-plugin-card
        ...
        <div class="flex-auto p-6 pt-0 sm:pt-4">
            ...
            <div class="mt-4">
                ...
                <p class="text-sm leading-normal">Choose between 2 .</p>
            </div>
            <div class="flex">
        ...
        upload() {
            return this.loader.file
                .then(file => new Promise((resolve, reject) => {
                    ...
                    fetch('{{ route('admin.articles.image.upload') }}', {
                        method: 'POST',
                        body: formData,
                    })
