<x-app-layout>
    ...
    <div class="w-full px-6 mx-auto">
        <!-- content -->
        <div
            class="relative flex flex-col mb-6 lg:w-2/3  min-w-0 mt-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
            <div
                class="p-4 pb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                                        ...
                                        <div
                                            ...
                                            <div class="flex-auto p-6">
                                                ...
                                                @if(!$article->published_at)
                                                    <form role="form"
                                                          action="{{route('admin.article.publish', ['slug'=> $article->slug])}}"
