<x-app-layout>
    ...
    <div class="w-full px-6 py-6 mx-auto">
                                                        ...
                                                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                                            <div class="w-3/4 mx-auto">
                                                                <div class="ml-auto text-right">
                                                                    @if($category->is_main && $category->children->count() == 0 || !$category->is_main && count($category->articles) == 0)
        ...
        <!-- Modal Structure -->
        <div id="deleteConfirmationModal" style="z-index:999999"
             class="fixed inset-0  hidden overflow-y-auto  bg-black bg-opacity-90">
